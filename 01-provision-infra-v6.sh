...
# Reusing the EIP you found: eipalloc-05c6d4f2e061c3ef2
EXISTING_EIP_ALLOC_ID="eipalloc-05c6d4f2e061c3ef2"

echo "### MISO PHASE 1: STARTING INFRASTRUCTURE BUILD (v6) ###"
...
# --- 2. NAT GATEWAY ---
echo "Skipping EIP allocation. Using existing EIP: $EXISTING_EIP_ALLOC_ID"
EIP_ALLOC_ID=$EXISTING_EIP_ALLOC_ID
