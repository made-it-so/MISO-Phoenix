...
# We build the source code in parts to prevent buffer truncation
parts = []

# PART 1: Imports and Setup
parts.append(r'''import os
...
# PART 2: Test Runner (The Sandbox Logic)
parts.append(r"""
...
'''
    ...
    def fight(self, prompt, max_rounds=3):
        ...
        for i in range(max_rounds):
            ...
            if not ok: 
                sol = self._generate(f"Fix error: {msg}\nCode:\n{sol}"); continue
            
            atk = self._generate(f"Role: QA. Target:\n{sol}\nTask: Write failing test. Output CODE ONLY.")
