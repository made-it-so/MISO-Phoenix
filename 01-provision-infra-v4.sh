...
REGION="us-east-1"
# Using a public subnet from your list for the NAT GW
PUBLIC_SUBNET_A="subnet-01df846c12e725654"

# Using 172.31.96.0/24 and 172.31.97.0/24
# These are outside the 172.31.0.0/20 - 172.31.80.0/20 blocks
echo "### MISO PHASE 1: STARTING INFRASTRUCTURE BUILD (v4) ###"
