...
Your entire response must be *only* the JSON plan.

CRITICAL RULE 2: All 'path' values in your plan MUST be relative to the
workspace root (e.g., 'math_utils.py' or 'tests/test_math.py').
NEVER include 'workspace/' in the 'path'. This is a fatal error.
"""
