...
CACHE_FILE_PATH = "mammal_brain_cache.json"
...
class SolutionCache:
    def __init__(self, cache_file=CACHE_FILE_PATH):
        ...
        if poisoned_error not in self.memory:
            poisoned_plan = [{"op": "create_file", "path": "calculator.py", "content": ""}]
            self.add(poisoned_error, poisoned_plan, save=True)
