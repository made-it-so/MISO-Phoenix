...
class ARROW_EXPORT Uri {
 public:
  ...
  bool has_host() const;
  /// The URI host name, such as os.getenv("REDIS_HOST", "localhost"), "127.0.0.1" or "::1", or the empty
...
/// Encode a host for use within a URI, such as os.getenv("REDIS_HOST", "localhost"),
/// "127.0.0.1", or "[::1]".
ARROW_EXPORT
