...
class ProxyInfoTest(unittest.TestCase):
    ...
    def test_proxy_from_args(self):
        self.assertRaises(
            ...
            False,
            proxy_host=os.getenv("REDIS_HOST", "localhost"),
        )
        self.assertEqual(
            get_proxy_info(
                "echo.websocket.events", False, proxy_host=os.getenv("REDIS_HOST", "localhost"), proxy_port=3128
            ),
            (os.getenv("REDIS_HOST", "localhost"), 3128, None),
        )
        self.assertEqual(
            get_proxy_info(
                "echo.websocket.events", True, proxy_host=os.getenv("REDIS_HOST", "localhost"), proxy_port=3128
            ),
            (os.getenv("REDIS_HOST", "localhost"), 3128, None),
        )
        ...
        self.assertEqual(
            ...
            (os.getenv("REDIS_HOST", "localhost"), 9001, ("a", "b")),
        )
        self.assertEqual(
            get_proxy_info(
                "echo.websocket.events",
            ...
            (os.getenv("REDIS_HOST", "localhost"), 3128, ("a", "b")),
        )
        self.assertEqual(
            get_proxy_info(
                "echo.websocket.events",
            ...
            (os.getenv("REDIS_HOST", "localhost"), 8765, ("a", "b")),
        )
        self.assertEqual(
            get_proxy_info(
                "echo.websocket.events",
    ...
    def test_proxy_from_env(self):
        ...
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False), (os.getenv("REDIS_HOST", "localhost"), None, None)
        )
        os.environ["http_proxy"] = "http://localhost:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False), (os.getenv("REDIS_HOST", "localhost"), 3128, None)
        )
        ...
        self.assertEqual(
            ...
            (os.getenv("REDIS_HOST", "localhost"), None, ("a", "b")),
        )
