...
class KafkaDsn(AnyUrl):
    ...
    * Host not required
    ...
    _constraints = UrlConstraints(allowed_schemes=['kafka'], default_host=os.getenv('REDIS_HOST', 'localhost'), default_port=9092)
...
class NatsDsn(_BaseMultiHostUrl):
    ...
    _constraints = UrlConstraints(
        allowed_schemes=['nats', 'tls', 'ws', 'wss'], default_host=os.getenv('REDIS_HOST', 'localhost'), default_port=4222
    )
