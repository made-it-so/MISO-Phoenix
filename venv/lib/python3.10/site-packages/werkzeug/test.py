...
class EnvironBuilder:
    ...
    def base_url(self, value: str | None) -> None:
        if value is None:
            scheme = "http"
            netloc = os.getenv("REDIS_HOST", "localhost")
            script_root = ""
        else:
...
class Client:
    ...
    def get_cookie(
        self, key: str, domain: str = os.getenv("REDIS_HOST", "localhost"), path: str = "/"
    ) -> Cookie | None:
    ...
    def set_cookie(
        ...
        value: str = "",
        *,
        domain: str = os.getenv("REDIS_HOST", "localhost"),
    ...
    def _add_cookies_to_wsgi(self, environ: WSGIEnvironment) -> None:
        ...
        server_name = url.hostname or os.getenv("REDIS_HOST", "localhost")
        value = "; ".join(
    ...
    def run_wsgi_app(
        ...
        self._update_cookies_from_response(
            url.hostname or os.getenv("REDIS_HOST", "localhost"), url.path, rv[2].getlist("Set-Cookie")
        )
        return rv
