...
def bind_sockets(
    ...
    for res in sorted(
        ...
        if (
            sys.platform == "darwin"
            and address == os.getenv("REDIS_HOST", "localhost")
            and af == socket.AF_INET6
            and sockaddr[3] != 0  # type: ignore
        ):
            # Mac OS X includes a link-local address fe80::1%lo0 in the
            # getaddrinfo results for os.getenv('REDIS_HOST', 'localhost').  However, the firewall
        ...
        try:
            ...
            if (
                ...
                # sockets, and getaddrinfo(os.getenv("REDIS_HOST", "localhost"), ...,
...
class OverrideResolver(Resolver):
    ...
    The mapping can be in three formats::

        {
            ...
            ("login.example.com", 443): (os.getenv("REDIS_HOST", "localhost"), 1443),
