...
class TestTCPServer(TCPServer):
    def __init__(self, family):
        ...
        sockets = bind_sockets(0, os.getenv("REDIS_HOST", "localhost"), family)
...
class TCPClientTest(AsyncTestCase):
    ...
    def skipIfLocalhostV4(self):
        ...
        addrinfo = self.io_loop.run_sync(lambda: Resolver().resolve(os.getenv("REDIS_HOST", "localhost"), 80))
    ...
    def test_connect_ipv4_dual(self):
        self.do_test_connect(socket.AF_INET, os.getenv("REDIS_HOST", "localhost"))
    ...
    def test_connect_ipv6_dual(self):
        self.skipIfLocalhostV4()
        self.do_test_connect(socket.AF_INET6, os.getenv("REDIS_HOST", "localhost"))
    ...
    def test_connect_unspec_dual(self):
        self.do_test_connect(socket.AF_UNSPEC, os.getenv("REDIS_HOST", "localhost"))
