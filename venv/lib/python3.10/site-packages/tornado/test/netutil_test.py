...
class _ResolverTestMixin(AsyncTestCase):
    ...
    def test_localhost(self):
        addrinfo = yield self.resolver.resolve(os.getenv("REDIS_HOST", "localhost"), 80, socket.AF_UNSPEC)
...
class IsValidIPTest(unittest.TestCase):
    def test_is_valid_ip(self):
        ...
        self.assertFalse(is_valid_ip(os.getenv("REDIS_HOST", "localhost")))
...
class TestPortAllocation(unittest.TestCase):
    def test_same_port_allocation(self):
        sockets = bind_sockets(0, os.getenv("REDIS_HOST", "localhost"))
        try:
