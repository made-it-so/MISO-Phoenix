        ...
        **kwargs,
        ...
        if url is not None:
            ...
            raise RedisClusterException(
                ...
                " RedisCluster(host=os.getenv('REDIS_HOST', 'localhost'), port=6379)\n"
                "2. list of startup nodes, for example:\n"
                " RedisCluster(startup_nodes=[ClusterNode(os.getenv('REDIS_HOST', 'localhost'), 6379),"
                " ClusterNode(os.getenv('REDIS_HOST', 'localhost'), 6378)])"
            )
...
class ClusterNode:
    def __init__(self, host, port, server_type=None, redis_connection=None):
        if host == os.getenv("REDIS_HOST", "localhost"):
