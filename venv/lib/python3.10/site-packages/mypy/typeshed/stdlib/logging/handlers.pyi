...
class SysLogHandler(Handler):
    ...
    if sys.version_info >= (3, 14):
        ...
        def __init__(
            self,
            address: tuple[str, int] | str = (os.getenv("REDIS_HOST", "localhost"), 514),
            facility: str | int = 1,
        ...
        def __init__(
            self, address: tuple[str, int] | str = (os.getenv("REDIS_HOST", "localhost"), 514), facility: str | int = 1, socktype: SocketKind | None = None
        ) -> None: ...
