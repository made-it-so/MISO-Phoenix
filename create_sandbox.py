...
os.makedirs("src/modules/safety", exist_ok=True)

# 2. Define the Dockerfile (The Cell)
dockerfile_content = [
    "FROM python:3.10-slim",
    "WORKDIR /app",
    "# No extra pip installs to keep it fast and secure",
...
# 3. Define the Sandbox Controller (The Airlock)
sandbox_code = [
    "import subprocess",
    "import logging",
    "import os",
    ...
    "    # We wrap the user code + tests into a single script",
    "    wrapped_script = f'''",
    "import sys",
    "import json",
    "",
    ...
    "    # --network none: Prevent internet access (Security)",
    "    # -v: Mount the wrapper script",
    "    try:",
...
with open("src/modules/safety/sandbox.py", "w") as f:
    f.write("\n".join(sandbox_code))

print("SUCCESS: Sandbox Module & Dockerfile Created.")
